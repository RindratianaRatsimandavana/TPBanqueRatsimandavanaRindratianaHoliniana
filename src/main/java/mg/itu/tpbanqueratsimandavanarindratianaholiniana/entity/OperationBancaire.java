 ...
 */
package mg.itu.tpbanqueratsimandavanarindratianaholiniana.entity;
...
public class OperationBancaire implements Serializable {
    ...
    public String toString() {
        return "mg.itu.tpbanqueratsimandavanarindratianaholiniana.entity.OperationBancaire[ id=" + id + " ]";
    }
